...
(function () {
  ...
  function updateLoadingDisplay() {
    ...
    const lines = [
      ...
      '<a href="https://www.tiktok.com/@tasdiam" style="font-size: 15px; color: #d42222; text-decoration: underline; margin-bottom: 10px; display: block;">tasdiam</a>',
      '<a href="https://docs.google.com/document/d/1_FmH3BlSBQI7FGgAQL59-ZPe8eCxs35wel6JUyVaG8Q/" style="font-size: 15px; color: #14b4f3; text-decoration: underline; margin-bottom: 10px; display: block;">riddy</a>',
    ];
...
for (let i = 1; i <= numParts; i++) {
  ...
  function shouldInterceptFile(url) {
    ...
    //if (urlStr.includes(".part")) return null; this is fine i think
